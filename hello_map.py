...
# Mapping of syscall IDs to names (for common syscalls)
syscall_map = {
    0: "read",
    1: "write",
    2: "open",
...
# Function to get syscall name from ID
def get_syscall_name(syscall_id):
    return syscall_map.get(syscall_id, str(syscall_id))
...
def print_event():
    ...
    for k, v in sorted(items):
        syscall_name = get_syscall_name(k)
        print("%-18s %-16d" % (syscall_name, v))
    counter_table.clear()
